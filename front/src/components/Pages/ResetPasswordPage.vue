      ...
      <div class="form-header">
        <svg class="header-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
          ...
          <path stroke-linecap="round" stroke-linejoin="round"
                d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.628 5.855M15 7A7.488 7.488 0 0012 4.545V7M15 7h.01M9 12.25c0 .967.394 1.848.996 2.497M9 12.25c0-1.06.398-2.031 1-2.775M12 17.25c0 .414.162.787.432 1.064M12 17.25V14.25"/>
          <path stroke-linecap="round" stroke-linejoin="round"
                d="M12 14.25c-1.057 0-2.054.257-2.86.709M9 21a3 3 0 01-3-3V7.5a3 3 0 013-3h6a3 3 0 013 3v3.75M9 21a3 3 0 003 3h3M9 21v-2.25M15 18.75a3 3 0 003-3v-1.5M15 18.75a3 3 0 01-3 3M15 18.75v-2.25"/>
        </svg>
        ...
        <div class="form-group" v-if="!success">
          ...
          <div class="input-wrapper">
            <input
                ...
                @input="clearMessages"
            />
            <button type="button" @click="togglePasswordVisibility('password')" class="password-toggle-icon"
                    :title="passwordFieldType === 'password' ? 'Показати пароль' : 'Приховати пароль'">
              <svg v-if="passwordFieldType === 'password'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
              ...
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
                      ...
                      clip-rule="evenodd"/>
                <path
                    d="M12.454 16.697L9.75 13.992a4 4 0 01-3.742-3.741L2.335 6.578A9.98 9.98 0 00.458 10c1.274 4.057 5.022 7 9.542 7 1.126 0 2.207-.245 3.231-.666l-1.748-1.747zm-2.89 1.43A7.952 7.952 0 0010 18c-3.182 0-5.993-1.756-7.628-4.545L4.46 11.01A7.951 7.951 0 0010 14.545c.283 0 .56-.017.833-.05l1.737 1.736z"/>
              </svg>
            </button>
          </div>
        </div>
        ...
        <div class="form-group" v-if="!success">
          ...
          <div class="input-wrapper">
            <input
                ...
                @input="clearMessages"
            />
            <button type="button" @click="togglePasswordVisibility('confirm')" class="password-toggle-icon"
                    :title="confirmPasswordFieldType === 'password' ? 'Показати пароль' : 'Приховати пароль'">
              <svg v-if="confirmPasswordFieldType === 'password'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                   viewBox="0 0 20 20" fill="currentColor">
                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                <path fill-rule="evenodd"
                      d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.022 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z"
...
const resetPassword = async () => {
  ...
  try {
    ...
    confirm.value = "";
    setTimeout(() => {
      if (formMessage.value.type === 'success') {
        router.push("/login");
      }
    }, 3000);
