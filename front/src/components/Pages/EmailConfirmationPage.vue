    ...
    <div class="message-card">
      ...
      <div v-else>
        <div v-if="success" class="status-section success-state">
          <svg class="status-icon success-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <div v-else class="status-section error-state">
          <svg class="status-icon error-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
               stroke="currentColor" stroke-width="2">
          ...
          <p class="status-subtext">Будь ласка, спробуйте перейти за посиланням з листа ще раз або зверніться до
            підтримки.</p>
