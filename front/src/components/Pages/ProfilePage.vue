      ...
      <div class="content-grid">
        <section class="content-section author-pages-section">
          ...
          <div v-if="authorPages.length" class="cards-container">
            ...
            >
              <img :src="author.avatarUrl || '/default-avatar.png'" :alt="`Аватар @${author.username}`" class="card-avatar"/>
              <div class="card-info">
                <h3 class="card-title">
              ...
              <router-link :to="`/author/${author.username}`" class="button-card-action">
                Перейти
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1.5 inline-block" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
              </router-link>
            </div>
          </div>
        ...
        <section class="content-section subscriptions-section">
          <h2 class="section-title">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2.5 inline-block text-cyan-500/80" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" /></svg>
            Ваші підписки
          </h2>
            ...
            >
              <div class="card-info">
                ...
                <p class="card-expiry-date">
                  До: {{ new Date(subscription.expiresAt).toLocaleDateString('uk-UA', { day: '2-digit', month: 'long', year: 'numeric' }) }}
                </p>
              </div>
            </div>
          </div>
...
@media (min-width: 640px) {
  .author-card .card-avatar { margin-right: 0.75rem; margin-bottom: 0; }
}
...
@media (min-width: 640px) {
  .author-card .button-card-action { margin-top: 0; margin-left: auto; }
}
